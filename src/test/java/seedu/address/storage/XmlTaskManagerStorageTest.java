...
public class XmlTaskManagerStorageTest {
    ...
    private java.util.Optional<ReadOnlyTaskManager> readTaskManaer(String filePath) throws Exception {
    ...
    public void read_missingFile_emptyResult() throws Exception {
        assertFalse(readTaskManaer("NonExistentFile.xml").isPresent());
    }
    ...
    public void read_notXmlFormat_exceptionThrown() throws Exception {
        ...
        readTaskManaer("NotXmlFormatTaskManager.xml");
