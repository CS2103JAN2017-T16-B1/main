...
public class EditCommandParser {
    ...
    public Command parse(String args) {
        ...
        try {
            ...
            editPersonDescriptor.setDescription(ParserUtil.parsePhone(argsTokenizer.getValue(PREFIX_PHONE)));
            editPersonDescriptor.setStartTime(ParserUtil.parseEmail(argsTokenizer.getValue(PREFIX_EMAIL)));
            editPersonDescriptor.setEndTime(ParserUtil.parseAddress(argsTokenizer.getValue(PREFIX_ADDRESS)));
