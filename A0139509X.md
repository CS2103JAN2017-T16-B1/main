# A0139509X
###### \main\java\seedu\taskManager\commons\events\ui\ScrollToListRequestEvent.java
``` java
/**
...
```
###### \main\java\seedu\taskManager\logic\commands\FindCommand.java
``` java
...
```
###### \main\java\seedu\taskManager\logic\commands\ToggleCommand.java
``` java
...
```
###### \main\java\seedu\taskManager\logic\parser\FindCommandParser.java
``` java
...
```
###### \main\java\seedu\taskManager\model\Model.java
``` java
...
```
###### \main\java\seedu\taskManager\model\Task\TaskStringReference.java
``` java
...
```
###### \main\java\seedu\taskManager\ui\CommandBox.java
``` java
...
```
###### \main\java\seedu\taskManager\ui\ResultDisplay.java
``` java
    @Subscribe
...
```
###### \main\java\seedu\taskManager\ui\TaskCard.java
``` java
...
```
###### \main\java\seedu\taskManager\ui\TaskListPanel.java
``` java
...
```
###### \test\java\guitests\AutoFocusTest.java
``` java
...
```
###### \test\java\guitests\FindCommandTest.java
``` java
    @Test
...
```
###### \test\java\guitests\guihandles\MainMenuHandle.java
``` java
...
```
###### \test\java\guitests\guihandles\TaskCardHandle.java
``` java
...
```
###### \test\java\guitests\ToggleCommandTest.java
``` java
